...
public class Main {
    ...
    public static void Variable1_1(){
        boolean flag;
        char grade;
        byte val;
        short sval;
    ...
    public static void Variable1_2(){
        boolean flag = false;
        char grade = 'A';
        byte val = 127;
        short sval = 128;
    ...
    public static void Variable1_3() {
        int year, age = 23;
    ...
    public static void Variable1_4(){
        int num; // 지역 변수
...
//        System.out.println("instanceVal = " + instanceVal); // Error 발생
        Main instance = new Main (); // 인스턴스 변수 사용을 위해 객체 생성
        System.out.println("instanceVal = " + instance.instanceVal); // 100

        // 클래스 변수
        System.out.println("classVal = " + classVal);
        // 같은 크래스 내부는 바로 접근 가능
        System.out.println("Main.classVal = " + Main.classVal);
        // 클래스 변수 : 클래스명.클래스변수명 으로 접근 or
    }

    public static void Variable2_1(){
        int score = 100;
...
//         finalScore = 90; // Error 발생
    ...
    public static void Variable2_2(){
        int score = 100;
        final int finalScore = 1000;
    }

    public static void Variable2_3(){
    ...
    public static void Variable3_1(){
        // 부호있는 경우
        short sMin = -32768;
        short sMax = 32767;
    ...
    public static void Variable3_2(){
        int num = 5;
        char ch = '5';
    ...
    public static void Variable3_3(){
        int num = 5;
        char ch = '5';
    ...
    public static void Variable3_4(){
        String str1 = "100";
        String str2 = "3.14";
        String str3 = "8";
...
//         System.out.println("Integer.parseInt(str2) = " + Integer.parseInt(str2)); // Error 발생
    ...
    public static void Variable3_5(){
        // Date import 필요!
    ...
    public static void Variable4_1(){
        char ch1 = 'A'; // 문자
    ...
    public static void Variable4_2(){
        String s1 = "A" + "B"; // "AB"
    ...
    public static void Variable4_3() {
        int x = 10, y = 20;
        // x 와 y 값을 교환해 보겠습니다.
        x = y; // x = 20;
